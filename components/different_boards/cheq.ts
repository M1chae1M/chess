...
const boardStartState={
  ...
  C:{
    ...
    3:'',
    4:new Bishop('white','C4',true,'Bishop'),
    5:new Bishop('black','C5',true,'Bishop'),
    6:'',
  ...
  E:{
    ...
    2:'',
    3:'',
    4:new Pawn('white','E4',true,'Pawn'),
    5:new Pawn('black','E5',true,'Pawn'),
    6:'',
    7:'',
  ...
  F:{
    ...
    3:new Queen('white','F3',true,'Queen'),
    4:'',
    5:'',
    6:'',
