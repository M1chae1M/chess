...
import setBoardInLocalStory from '@/functions/setBoardInLocalStory.ts'
import checkIsClosed from '@/functions/checkIsClosed.ts'
import componentDidMount from '@/functions/componentDidMount.ts'
